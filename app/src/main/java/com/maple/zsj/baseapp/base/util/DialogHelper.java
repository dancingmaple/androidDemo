package com.maple.zsj.baseapp.base.util;
...
import com.maple.zsj.baseapp.base.adapter.CommentItemAdapter;
...
public final class DialogHelper {
    ...
    public static AlertDialog.Builder getRecyclerViewDialog(Context context, BaseRecyclerAdapter.OnItemClickListener listener) {
        ...
        recyclerView.setPadding(TDevice.dipTopx(context, 16), TDevice.dipTopx(context, 16),
                TDevice.dipTopx(context, 16), TDevice.dipTopx(context, 16));
