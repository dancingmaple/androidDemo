...
import com.maple.zsj.baseapp.base.adapter.BaseGeneralRecyclerAdapter;
import com.maple.zsj.baseapp.base.adapter.BaseRecyclerAdapter;
import com.maple.zsj.baseapp.base.app.AppConfig;
import com.maple.zsj.baseapp.base.entity.PageBean;
import com.maple.zsj.baseapp.base.entity.ResultBean;
import com.maple.zsj.baseapp.base.util.AppOperator;
import com.maple.zsj.baseapp.base.util.TDevice;
import com.maple.zsj.baseapp.base.util.TLog;
import com.maple.zsj.baseapp.base.view.RecyclerRefreshLayout;
import com.maple.zsj.baseapp.base.view.SimplexToast;
import com.maple.zsj.baseapp.base.view.ui.EmptyLayout;
    ...
    public void initData() {
        ...
        mHandler = new TextHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                ...
                try {
                    ResultBean<PageBean<T>> resultBean = null ; //AppOperator.createGson().fromJson(responseString, getType());
        ...
        if (isNeedEmptyView) {
            ...
            List<T> items = isNeedCache()
                    ? null //(List<T>) CacheManager.readListJson(getActivity(), CACHE_NAME, getCacheClass())
                    : null;
